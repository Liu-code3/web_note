...
![img](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzYtMy0zLnBuZw?x-oss-process=image/format,png)
...
![width和height属性](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzExLTItMy5wbmc?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzExLTQtMy5wbmc?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzExLTUtMy5wbmc?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzEyLTEtMS5wbmc?x-oss-process=image/format,png)
...
![正常文档流显示](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzEyLTEtMy5wbmc?x-oss-process=image/format,png)正常文档流显示

上图1就是按照正常文档流显示的效果图。

然后，所谓的脱离文档流就是指它所显示的位置和文档代码的顺序不一致了，比如可以用CSS控制，把最后一个div元素显示在第一个div元素的位置，如下图：

![脱离文档流显示](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzEyLTEtNC5wbmc?x-oss-process=image/format,png)图2 脱离文档流显示
...
![img](https://imgconvert.csdnimg.cn/aHR0cDovL3d3dy5sdnllc3R1ZHkuY29tL0FwcF9pbWFnZXMvbGVzc29uL2NqLzEyLTItMS5wbmc?x-oss-process=image/format,png)
...
# 三、Flexible(flex)布局入门到彻底理解

# 1.简介

## 1.1 概述

浮动在移动布局中不再重要，[flex](https://so.csdn.net/so/search?q=flex&spm=1001.2101.3001.7020)盒模型越来越重要。
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy8zNzkxZTU3NWM0OGIzNjk4YmU2YTk0YWUxZGJmZjc5ZC5wbmc?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy8wY2JlNWY4MjY4MTIxMTE0ZTg3ZDA1NDZlNTNjZGE2ZS5wbmc?x-oss-process=image/format,png)

## 3.2 flex-wrap值：

- nowrap(默认) 不换行

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy85ZGExZjIzOTY1NzU2NTY4YjRjNmVhNzEyNGRiN2I5YS5wbmc?x-oss-process=image/format,png)

- wrap 换行，第一行在上方

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy8zYzZiM2M4YjhmZTVlMjZiY2E2ZmI1NzUzOGNmNzJkOS5qcGc?x-oss-process=image/format,png)

- wrap-reverse 换行，第一行在下方

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy9mYjRjZjJiYWI4YjZiNzQ0YjY0ZjZkN2E5OWNkNTc3Yy5qcGc?x-oss-process=image/format,png)

> 默认情况，所有flex项目会排在一条线上，不会自动换行

## 3.3 flex-flow默认值：row nowrap
...
- box-borient:horizontal|vertical|inline-axis|block-axis|inherit;该属性定义父元素中的子元素是如何排列的。horizontal对父元素的宽度分配划分。
- box-pack:start|end|center|justify;box-pack表示父容器里面子容器的水平对齐方
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9pbWFnZXMyMDE4LmNuYmxvZ3MuY29tL2Jsb2cvMzE1MzAyLzIwMTgwNS8zMTUzMDItMjAxODA1MjIxMTM0NDU3MzctMzI2NDIyMjk5LnBuZw?x-oss-process=image/format,png)

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9pbWFnZXMyMDE4LmNuYmxvZ3MuY29tL2Jsb2cvMzE1MzAyLzIwMTgwNS8zMTUzMDItMjAxODA1MjIxMTM2MjM1NzUtMTA5ODMzNTkzOS5wbmc?x-oss-process=image/format,png)

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9pbWFnZXMyMDE4LmNuYmxvZ3MuY29tL2Jsb2cvMzE1MzAyLzIwMTgwNS8zMTUzMDItMjAxODA1MjIxMTM3MTU0ODctMjAyMTUyNDcxOC5wbmc?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy81OWUzOTljNzJkYWFmY2ZjYzIwZWRlMzZiZjMyZjI2Ni5wbmc?x-oss-process=image/format,png)

- flex-grow 定义项目放大比例，默认为0

> 如果所有项目flex-grow属性为1，它们将等分剩余空间。以此类推

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy9mNDFjMDhiYjM1OTYyZWQ3OWU3Njg2ZjczNWQ2Y2Q3OC5wbmc?x-oss-process=image/format,png)
...
![flex-shink](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy8yNDBkM2U5NjAwNDNhNzI5YmIzZmY1ZTM0OTg3OTA0Zi5qcGc?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy81NWIxOTE3MWI4YjZiOTQ4N2Q3MTdiZjJlY2JiYTZkZS5wbmc?x-oss-process=image/format,png)
...
设置`display`属性为`flex`或者`inline-flex`可以试之成为`flex container`
...
![img](https://img-blog.csdnimg.cn/20200731104212909.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**flex-end:**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104226923.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**center**:

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104240646.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**space-between:**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104313656.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**space-around:**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104331486.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**space-evenly:**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104342859.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104401996.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**flex-start：**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104416553.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**flex-end：**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104430672.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**center：**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104446355.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**baseline：**(基准线以第一个为准)

![在这里插入图片描述](https://img-blog.csdnimg.cn/2020073110450082.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104535541.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

![在这里插入图片描述](https://img-blog.csdnimg.cn/2020073110455031.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

# 5.flex-wrap

- nowrap(默认) 不换行

![nowrap](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy85ZGExZjIzOTY1NzU2NTY4YjRjNmVhNzEyNGRiN2I5YS5wbmc?x-oss-process=image/format,png)

- wrap 换行，第一行在上方

![wrap](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy8zYzZiM2M4YjhmZTVlMjZiY2E2ZmI1NzUzOGNmNzJkOS5qcGc?x-oss-process=image/format,png)

- wrap-reverse 换行，第一行在下方

![wrap-reverse](https://imgconvert.csdnimg.cn/aHR0cHM6Ly93d3cucnVub29iLmNvbS93cC1jb250ZW50L3VwbG9hZHMvMjAxNS8wNy9mYjRjZjJiYWI4YjZiNzQ0YjY0ZjZkN2E5OWNkNTc3Yy5qcGc?x-oss-process=image/format,png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104612822.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**wrap：**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104628947.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**wrap-reverse：**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104641636.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104701168.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**flex-flow: row-reverse wrap**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104714590.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)

**flex-flow: row-reverse wrap**

**justify-content: space-evenly**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104727201.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104755461.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104806408.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104827592.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104920235.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104936473.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200731104951502.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3d1eXhpbnU=,size_16,color_FFFFFF,t_70)
